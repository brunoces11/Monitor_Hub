...
export const organicSiteCampaignData = {
  reach: '18,460',
  newLeads24h: 74,
  leadConvRate: '9.6%',
  salesConvRate: '3.1%',
  ...
  status: 'Stable',
  chartData: [
    { day: 'Mon', leads: 14, sales: 4 },
    { day: 'Tue', leads: 11, sales: 3 },
    { day: 'Wed', leads: 9, sales: 3 },
    { day: 'Thu', leads: 12, sales: 4 },
    { day: 'Fri', leads: 10, sales: 2 },
    { day: 'Sat', leads: 8, sales: 2 },
    { day: 'Sun', leads: 10, sales: 3 },
  ],
  funnelData: [
    { name: 'Reach', value: 18460 },
    { name: 'Engaged', value: 4120 },
    { name: 'Leads', value: 602 },
    { name: 'Sales', value: 119 },
  ],
};

export const organicYoutubeCampaignData = {
  reach: '33,780',
  newLeads24h: 91,
  leadConvRate: '7.8%',
  salesConvRate: '2.6%',
  ...
  status: 'Growing',
  chartData: [
    { day: 'Mon', leads: 16, sales: 5 },
    { day: 'Tue', leads: 18, sales: 4 },
    { day: 'Wed', leads: 12, sales: 3 },
    { day: 'Thu', leads: 15, sales: 5 },
    { day: 'Fri', leads: 11, sales: 3 },
    { day: 'Sat', leads: 9, sales: 2 },
    { day: 'Sun', leads: 10, sales: 2 },
  ],
  funnelData: [
    { name: 'Reach', value: 33780 },
    { name: 'Engaged', value: 5810 },
    { name: 'Leads', value: 714 },
    { name: 'Sales', value: 143 },
  ],
};
...
export const leadGenerationData = [
  ...
  {
    dateRegistered: '20/06/2026',
    userName: 'Fernanda Rocha',
    email: 'fernanda.rocha@ecomlabs.com',
    phone: '+55 11 99654-1308',
  ...
  },
  {
    ...
    email: 'lucas.almeida@consultpro.io',
    phone: '+55 62 99218-4701',
    source: 'YouTube',
    product: 'Video Publisher',
    status: 'Purchased',
  },
  {
    dateRegistered: '19/06/2026',
    userName: 'Carolina Souza',
    email: 'carolina.souza@northpeak.co',
    phone: '+55 71 99843-5529',
    source: 'Referral',
    product: 'Creative Generation',
    status: 'Lead',
  },
  {
    ...
    email: 'diego.martins@fluxmedia.com',
    phone: '+55 51 99107-8842',
    source: 'Instagram Ads',
    product: 'Lead Parser',
    status: 'Purchased',
  },
  {
    dateRegistered: '18/06/2026',
    userName: 'Patricia Nunes',
    email: 'patricia.nunes@brandforge.ai',
    phone: '+55 48 99752-6614',
    source: 'Google Ads',
    product: 'Campaign Monitor',
    status: 'Refunded',
  },
  {
    ...
    email: 'gustavo.ribeiro@venturix.com',
    phone: '+55 85 99614-2207',
    source: 'Landing Page',
    product: 'Video Publisher',
    status: 'Lead',
  },
  {
    dateRegistered: '17/06/2026',
    userName: 'Amanda Teixeira',
    email: 'amanda.teixeira@ora.digital',
    phone: '+55 11 99533-7006',
    source: 'Facebook Ads',
    product: 'Creative Generation',
    status: 'Purchased',
  },
  {
    dateRegistered: '17/06/2026',
    userName: 'Henrique Melo',
    email: 'henrique.melo@rocketops.io',
    phone: '+55 31 99825-9130',
    source: 'Organic Search',
    product: 'Lead Parser',
    status: 'Lead',
  },
  {
    dateRegistered: '16/06/2026',
    userName: 'Camila Duarte',
    email: 'camila.duarte@pulsecrm.com',
    phone: '+55 21 99376-4488',
    source: 'YouTube',
    product: 'Campaign Monitor',
    status: 'Purchased',
  },
...
export const meetingTranscriptions = [
  {
    ...
    summary: 'The team aligned on launch readiness, finalized campaign handoff details, and confirmed the CRM cleanup path. The meeting also clarified the creative review status and the next reporting cadence for the upcoming Q3 push.',
    participants: [
  ...
  {
    id: 'mtg-meet-2026-06-26',
    day: '26',
    month: 'JUN',
    title: 'Google Meet: onboarding blockers, pipeline hygiene, and support escalation coverage',
    summary: 'This review focused on onboarding friction across the first-week journey, lead pipeline hygiene before the monthly sync, and coverage gaps in support escalation windows. The group agreed on a tighter handoff between success and support to reduce unresolved tickets.',
    initiallyExpanded: false,
    participants: [
      { name: 'Rafael', initials: 'RA', color: '#2563EB' },
      { name: 'Bianca', initials: 'BI', color: '#14B8A6' },
      { name: 'Thiago', initials: 'TH', color: '#F97316' },
      { name: 'Livia', initials: 'LI', color: '#A855F7' },
      { name: 'Sofia', initials: 'SO', color: '#E11D48' },
    ],
    keyPoints: [
      'New clients are stalling during workspace setup because the onboarding checklist is missing role-specific guidance.',
      'Three stale opportunities in the pipeline are distorting the current success forecast and need reclassification.',
      'Support escalations after 6pm are bouncing between teams without a named fallback owner.',
      'The onboarding video library needs a shorter version tailored to self-serve accounts.',
    ],
    tasks: [
      { task: 'Rewrite onboarding checklist for admin and operator roles', owner: 'Bianca' },
      { task: 'Audit stale pipeline opportunities and update stage definitions', owner: 'Rafael' },
      { task: 'Assign evening escalation fallback coverage for support', owner: 'Thiago' },
      { task: 'Draft short onboarding walkthrough for self-serve accounts', owner: 'Livia' },
    ],
  },
  {
    id: 'mtg-whoop-2026-06-25',
    day: '25',
    month: 'JUN',
    title: 'WHOOP: recovery trends, creative testing cadence, and retention offer timing',
    summary: 'The team reviewed weekly recovery and engagement signals from the WHOOP cohort, compared creative test velocity against campaign goals, and discussed the best timing for a retention offer. The outcome was a more conservative rollout tied to behavioral triggers rather than fixed dates.',
    initiallyExpanded: false,
    participants: [
      { name: 'Mateus', initials: 'MT', color: '#0F766E' },
      { name: 'Helena', initials: 'HE', color: '#DB2777' },
      { name: 'Pedro', initials: 'PE', color: '#4F46E5' },
    ],
    keyPoints: [
      'Users with declining recovery scores are engaging less with high-intensity challenge messaging.',
      'Current creative testing cadence is too slow to validate the next retention angle before the monthly push.',
      'The retention offer should trigger after a drop in habit consistency instead of a fixed day-14 schedule.',
      'Email and push messaging need tighter segmentation by training intent and recent activity level.',
    ],
    tasks: [
      { task: 'Create lower-intensity messaging variants for at-risk recovery segments', owner: 'Helena' },
      { task: 'Accelerate weekly creative test schedule for retention experiments', owner: 'Pedro' },
      { task: 'Define behavioral trigger rules for the retention offer rollout', owner: 'Mateus' },
      { task: 'Map segmentation logic for email and push follow-up flows', owner: 'Pedro' },
    ],
  },
];
